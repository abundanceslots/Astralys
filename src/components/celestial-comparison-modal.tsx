...
const styles = StyleSheet.create({
  ...
  searchButton: { height: 48, justifyContent: 'center', paddingHorizontal: 14, borderRadius: 15, backgroundColor: '#C8BAF5' },
  searchButtonText: { color: '#171321', fontSize: 12, fontWeight: '900' },
