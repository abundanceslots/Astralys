...
const styles = StyleSheet.create({
  ...
  addButton: { minHeight: 44, alignItems: 'center', justifyContent: 'center', marginTop: 8, borderRadius: 12, backgroundColor: '#22283B' },
  addButtonDisabled: { opacity: 0.38 },
  addButtonText: { color: '#F4F1FF', fontSize: 12, fontWeight: '800' },
